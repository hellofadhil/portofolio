                        ...
                        <ScrollAnimationWrapper>
                            <Card className="mx-auto w-full max-w-2xl rounded-xl p-3">
                                ...
                                <p className="text-md text-muted-foreground">
                                    Passionate about web development and digital innovation, I enjoy learning and
                                    exploring new technologies to improve my skills. 
                                </p>
                                <br />
                                <p className="text-md text-muted-foreground">
                                I focus on building scalable web applications, designing RESTful APIs, and creating responsive user interfaces. 
                                Additionally, I have experience in developing IoT solutions integrated with AI
                                </p>
                            </Card>
                        </ScrollAnimationWrapper>
